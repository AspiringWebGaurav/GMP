      ...
      <div className="shrink-0 p-3 border-b light:border-gray-200 dark:border-white/10 light:bg-white dark:bg-white/5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold light:text-gray-900 dark:text-white">
              Modern Timesheet
            </h2>
          </div>
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md transition-all"
            ...
            <button
              className="flex items-center gap-1.5 px-3 py-1.5 light:bg-green-600 dark:bg-green-700 hover:bg-green-700 text-white text-sm font-medium rounded-md transition-all"
              title="Export PDF"
            >
            ...
            <button
              className="flex items-center gap-1.5 px-3 py-1.5 light:bg-purple-600 dark:bg-purple-700 hover:bg-purple-700 text-white text-sm font-medium rounded-md transition-all"
              title="Email Report"
            >
        ...
        {showNewEntry && (
          <div className="mt-3 p-4 rounded-lg light:bg-linear-to-br light:from-blue-50 light:to-indigo-50 dark:bg-linear-to-br dark:from-blue-900/20 dark:to-indigo-900/20 border light:border-blue-200 dark:border-blue-800/30 shadow-sm">
            ...
            <div className="flex items-center justify-between gap-3 mb-3">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-black/40 border light:border-gray-300 dark:border-white/20 rounded-lg hover:border-blue-500 transition-all"
                  type="button"
                >
                ...
                {showWeekPicker && (
                  <div
                    ref={weekPickerRef}
                    className="absolute top-full left-0 mt-2 w-80 bg-white dark:bg-gray-800 border light:border-gray-200 dark:border-white/20 rounded-lg shadow-xl z-50 p-3"
                  >
              ...
              {/* Entry Mode Toggle */}
              <div className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-black/40 border light:border-gray-300 dark:border-white/20 rounded-lg">
                <button
            ...
            {/* Mode Description */}
            <div className="mb-3 px-2 py-1.5 bg-white/50 dark:bg-black/20 rounded-md">
            ...
            <div className="flex items-center gap-3 mb-3">
              <div className="relative shrink-0">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-black/40 border light:border-gray-300 dark:border-white/20 rounded-lg hover:border-blue-500 transition-all group"
                  type="button"
                >
                ...
                {showTimePicker === "start" && (
                  <div
                    ref={timePickerRef}
                    className="absolute top-full left-0 mt-2 w-48 bg-white dark:bg-gray-800 border light:border-gray-200 dark:border-white/20 rounded-lg shadow-xl z-50 p-2"
                  >
              ...
              {newEntry.startTime && newEntry.endTime && (
                <div className="flex items-center gap-1.5 px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-md text-xs font-medium">
              ...
              <div className="flex gap-2">
                <div className="flex-1 relative">
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 text-sm rounded-lg border light:border-gray-300 dark:border-white/10 light:bg-white dark:bg-black/20 light:text-gray-900 dark:text-white placeholder:text-gray-400 resize-none"
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-all self-start"
            ...
            {newEntry.tags.length > 0 && (
              <div className="flex flex-wrap gap-1.5 mt-3">
                {newEntry.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-2.5 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 text-xs font-medium rounded-full flex items-center gap-1"
                  >
          ...
          <div className="flex gap-4 p-4 h-full min-w-min">
            {fetchingEntries ? (
              ...
              dayGroups.map((dayGroup) => (
                ...
                >
                  {/* Day Header */}
                  <div className="shrink-0 p-3 border-b light:border-gray-200 dark:border-white/10 light:bg-gray-50 dark:bg-black/20">
                    <div className="flex items-center justify-between">
                      <div>
                  ...
                  <div className="flex-1 overflow-y-auto p-3 space-y-2.5 scrollbar-thin">
                    {dayGroup.entries.map((entry, index) => (
                      <div
                        key={entry.id}
                        className="relative pl-6 pr-3 py-3 rounded-lg light:bg-linear-to-r light:from-gray-50 light:to-white dark:bg-linear-to-r dark:from-black/20 dark:to-transparent border light:border-gray-200 dark:border-white/5 hover:border-blue-400 hover:shadow-md transition-all group"
                      >
                        {/* Bullet Point */}
                        ...
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <div className="flex items-center gap-2 text-xs font-semibold">
                            <div className="flex items-center gap-1.5 px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 rounded-md">
                            ...
                            {entry.endTime && (
                              <>
                                ...
                                <div className="flex items-center gap-1.5 px-2 py-1 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 rounded-md">
